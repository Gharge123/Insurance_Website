...
<body>
  ...
  <div class="register">
      ...
      <form id="contact-form" method="post" action="daily_task2.php" autocomplete="off" name="google-sheet" style="display: flex; flex-wrap: wrap;">
  ...
  <table class="data-table" id="show">
       ...
       <tbody id="table-body">
           ...
           <?php
               ...
               $dbname = "bajaj"; // Replace with your database name
