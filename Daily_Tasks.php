...
<head>
    ...
    color: #fb873f;
    padding: 6px; /* Attractive color for icons */
}
.icon-container {
    flex-shrink: 0;
    margin-right: 15px;
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
                ...
                <a href="Daily_Tasks.php" class="nav-item nav-link active">Daily Tasks</a>
    ...
    <!-- Workdone Data -->
     <div class="container123">
       ...
       <form id="contact-form" method="post" action="task1.php" autocomplete="off" name="google-sheet" style="display: flex; flex-wrap: wrap;">
           <div class="form-group" style="flex: 1; min-width: 200px; margin-right: 10px;">
               <input type="date" name="taskdate" class="form-control" placeholder="Date *" required>
           </div>
           <div class="form-group" style="flex: 1; min-width: 200px; margin-right: 10px;">
               <select name="Companynm" class="form-control" required>
                   <option value="" disabled selected>Select Company *</option>
                   <option value="Bajaj Allianz General Insurance">Bajaj Allianz General Insurance</option>
                   <option value="BA Life Insurance">BA Life Insurance</option>
  ...
  <div class="container123">
    <div class="header1234">
        <h2>Filter Task Details</h2>
    </div>
   <form method="get" action="task1.php">
       <div class="form-group" style="flex: 1; min-width: 200px; margin-right: 10px;">
           <input type="date" name="filter_startdate" class="form-control" placeholder="Start Date *" required>
       </div>
       <div class="form-group" style="flex: 1; min-width: 200px; margin-right: 10px;">
           <input type="date" name="filter_enddate" class="form-control" placeholder="End Date *" required>
       </div>
       <div class="form-group" style="flex: 1; min-width: 200px;">
           <input type="submit" class="btnSubmit" value="Filter">
       </div>
   </form>
  </div>
        <table class="data-table" id="show">
             ...
             <tbody id="table-body">
                 ...
                 <?php
                     ...
                     $sql = "SELECT taskdate ,company_name, claim_no, work_done FROM tasks1";
                     $result = $conn->query($sql);

                     if ($result->num_rows > 0) {
                         while ($row = $result->fetch_assoc()) {
                             echo "<tr><td>{$row['taskdate']}</td><td>{$row['company_name']}</td><td>{$row['claim_no']}</td><td>{$row['work_done']}</td></tr>";
                         }
                     } else {
      ...
      <!-- <div class="filter-form">
          <form method="post" action="task.php">
              <div class="form-group">
                  <input type="date" name="filter_start_date" class="form-control" placeholder="Start Date">
              </div>
              <div class="form-group">
                  <input type="date" name="filter_end_date" class="form-control" placeholder="End Date">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  <input type="submit" name="filter_submit" class="btnSubmit" value="Filter">
              </div>
          </form>
      </div> -->
