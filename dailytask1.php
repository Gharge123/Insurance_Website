        ...
        <ul class="task-list" id="taskList">
            <li class="task">
                <div class="task-actions">
                    <div>
                        <span class="task-title"><a href="Workdone11.php"><b>Task 1</b></a></span>
            ...
            <li class="task">
                <div class="task-actions">
                    <div>
                        <span class="task-title task-completed"><a href="Workdone11.php"><b>Task 2</b></a></span>
            ...
            <li class="task">
                <div class="task-actions">
                    <div>
                        <span class="task-title"><a href="Workdone11.php">Task 3</a></span>
            ...
            <li class="task">
                <div class="task-actions">
                    <div>
                        <span class="task-title"><a href="Workdone11.php">Task 4</a></span>
            ...
            <li class="task">
                <div class="task-actions">
                    <div>
                        <span class="task-title"><a href="Workdone11.php">Task 5</a></span>
            ...
            <li class="task">
                <div class="task-actions">
                    <div>
                        <span class="task-title"><a href="Workdone11.php">Task 6</a></span>
        ...
        function addTask(event) {
            ...
            if (taskText !== '') {
                ...
                newTask.innerHTML = `
                    <div class="task-actions">
                        <div>
                            <span class="task-title"><a href="Workdone11.php">${taskText}</a></span>
